...
(function attachFraudAgent(root) {
  ...
  function formatFraudAlert(report) {
  ...
  root.StickmanFraudAgent = StickmanFraudAgent;
  root.formatStickmanFraudAlert = formatFraudAlert;
})(window);
